    ...
    return (
      <div className="main-bg">
        <Paper style={{padding: 20, marginTop: 30, marginBottom: 30, overflow: 'hidden'}}>
          ...
          <p>Whilst typed decks (e.g. Maps, Schedules, Directories) may look suspiciously like presentation coupling, it's not, the typing of collections does make sense so that maps only contain location cards and schedules  only contain events, how one chooses to display the contents is still totally down to the decisions made at the presentation layer of your consumers. In addition it is totally possible to make collections of mixed types in a MultiDeck so the optional typed decks (e.g. creating a "directory" deck for entity cards) only relate to contents - not presentation.</p>
